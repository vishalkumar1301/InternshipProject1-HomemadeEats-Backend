...
module.exports = {
    SignUpValidationRule: [ 
        ...
        body('userType').exists().withMessage(Constants.ErrorMessages.ProvideValidUserType).isInt({ min: 0, max: 2}).withMessage(Constants.ErrorMessages.UserTypeCanOnlyBe012)
    ]   
};